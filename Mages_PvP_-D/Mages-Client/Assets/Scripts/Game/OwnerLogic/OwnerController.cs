...
public class OwnerController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameClient.onTick += PhysicsUpdate;
    }
    ...
    public void PhysicsUpdate(uint tick)
    {
    ...
    private void Movement(InputBits input)
    {
        ...
        bool running = (input.inputBits & (uint)InputType.Running) != 0;
    ...
    public void RecordInput(InputBits input)
    {
    ...
    public void SetPositionVelocityDir(IntVector3D pos, IntVector3D vel, Vector2 dir)
    {
        _position = pos;
        _velocity = vel;
        _RotationX = dir.x;
    ...
    public void SetPos(IntVector3D pos)
    {
        _position = pos;
    }

    public IntVector3D GetPosition() => _position;
    public IntVector3D GetVelocity() => _velocity;
